function t396_init(t) {
    ...
    d && (t396_initTNobj(t, d), o = t396_detectResolution(t), e = document.getElementById("allrecords"), window.tn_window_width = document.documentElement.clientWidth, window.tn["ab" + t].scaleFactor = parseFloat((window.tn_window_width / o).toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / o).toFixed(3)), t396_switchResolution(t, o), t396_updateTNobj(t), t396_artboard_build("", t), i = "ontouchend" in document, window.addEventListener("resize", function() {
        tn_console(">>>> t396: Window on Resize event >>>>"), d.classList.add("t396_resizechange"), d && d.classList.contains("t396_fullscreenchange") ? d.classList.remove("t396_fullscreenchange") : t396_waitForFinalEvent(function() {
            (!window.t396__isMobile && !i || document.documentElement.clientWidth !== window.tn_window_width) && (t396_doResize(t), d.classList.remove("t396_resizechange"))
...
function t396_doResize(t) {
    var e = t396_isOnlyScalableBrowser(),
        ...
        e = (t396_removeElementFromDOM(i ? i.querySelector(".t396__scale-style") : null), e ? (e = i ? i.querySelectorAll(".tn-atom") : [], Array.prototype.forEach.call(e, function(t) {
        ...
        i = "ab" + t,
        a = e ? e.clientWidth : 0,
        i = (window.tn_window_width = document.documentElement.clientWidth, window.tn[i].scaleFactor = parseFloat((window.tn_window_width / o).toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / o).toFixed(3)), window.tn_scale_offset = (a * window.tn_scale_factor - a) / 2, t396_switchResolution(t, o), t396_updateTNobj(t), t396_ab__renderView(e), n ? n.getAttribute("data-tilda-mode") : "");
    "window" === t396_ab__getFieldValue(e, "upscale") && "edit" !== i && t_onFuncLoad("t396_scaleBlock", function() {
        t396_scaleBlock(t)
...
function t396_detectResolution(t) {
    var e, i;
    if (t) return e = window.t396__isMobile ? document.documentElement.clientWidth : window.innerWidth, window.tn["ab" + t].screens.forEach(function(t) {
        t <= e && (i = t)
    }), i
}
...
function t396_elem__getFieldValue(t, e) {
    if (t = t396_getEl(t)) {
        ...
        if (!(dataField = a === r ? t.getAttribute("data-field-" + e + "-value") : t.getAttribute("data-field-" + e + "-res-" + a + "-value")) && "" !== dataField)
            for (var l = 0; l < d.length; l++) {
                var _ = d[l];
                if (!(_ <= a) && (dataField = _ === r ? t.getAttribute("data-field-" + e + "-value") : t.getAttribute("data-field-" + e + "-res-" + _ + "-value"))) break
            }
        return dataField
    }
}
...
function t396_elem__renderViewOneField(t, e) {
    if ((t = t396_getEl(t)) && "yes" !== t.getAttribute("data-scale-off")) {
        var i, n, o, a, r, d = t396_elem__getFieldValue(t, e);
        switch (e) {
            case "left":
                d = t396_elem__convertPosition__Local__toAbsolute(t, e, d), t.style.left = parseFloat(d).toFixed(1) + "px";
                break;
            case "top":
                d = t396_elem__convertPosition__Local__toAbsolute(t, e, d), t.style.top = parseFloat(d).toFixed(1) + "px";
                break;
            case "width":
                switch (d = t396_elem__getWidth(t, d), t.style.width = parseFloat(d).toFixed(1) + "px", _ = t.getAttribute("data-elem-type")) {
                    case "tooltip":
                        ...
                        break;
                    case "gallery":
                        i = t396_elem__getFieldValue(t, "borderwidth"), n = t396_elem__getFieldValue(t, "borderstyle"), d -= 2 * (i = n && i && "none" !== n ? i : 0), o = parseFloat(d).toFixed(1) + "px", a = t.querySelector(".t-slds__main"), r = t.querySelectorAll(".tn-atom__slds-img"), t.style.width = o, a && (a.style.width = o), Array.prototype.forEach.call(r, function(t) {
                            t.style.width = o
                        })
                }
                break;
    ...
    if (t = t396_getEl(t)) {
        ...
        switch (i = parseInt(i), e) {
            ...
            case "top":
                ...
                var b, f = t.parentNode,
                    m = (f = f.classList.contains("t396__artboard") ? f : f.parentNode) ? f.getAttribute("data-artboard-proxy-min-offset-top") : "0",
                    y = f ? f.getAttribute("data-artboard-proxy-min-height") : "0",
                    F = f ? f.getAttribute("data-artboard-proxy-max-height") : "0",
                    m = (h = "grid" === g ? "grid" : "window", "grid" === g ? parseFloat(m) : 0),
                    y = "grid" === g ? parseFloat(y) : parseFloat(F),
                    F = ("%" === t396_elem__getFieldValue(t, "topunits") && (i = y * (i / 100)), s && "window" !== h && (i *= window.tn_scale_factor), i = (m = c && "window" !== h ? "stretch" === r ? 0 : m / window.tn_scale_factor : m) + i, t396_ab__getFieldValue(f, "height_vh")),
                    m = t396_ab__getFieldValue(f, "height"),
                    v = t396_ab__getHeight(f);
                d && !l && F && (b = parseInt(m, 10) * window.tn_scale_factor), "center" === u && (n = p(t), s && "window" !== h && ("stretch" !== r ? y *= window.tn_scale_factor : y = b ? v < b ? b : v : f.clientHeight, n *= window.tn_scale_factor), l || !d || _ || "window" === h || "stretch" !== r || (y = b ? v < b ? b : v : f.clientHeight, y /= window.tn_scale_factor), i = y / 2 - n / 2 + i), "bottom" === u && (n = p(t), s && "window" !== h && ("stretch" !== r ? y *= window.tn_scale_factor : y = b ? v < b ? b : v : f.clientHeight, n *= window.tn_scale_factor), l || !d || _ || "window" === h || "stretch" !== r || (y = b ? v < b ? b : v : f.clientHeight, y /= window.tn_scale_factor), i = y - n + i), s && "window" !== h && (i += ((n = p(t)) * window.tn_scale_factor - n) / 2)
        }
        return i
    }
}

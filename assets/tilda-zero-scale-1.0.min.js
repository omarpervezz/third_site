function t396_scaleBlock(e) {
    var t, o, w = t396_isOnlyScalableBrowser(),
        ...
        if ("grid" === o)
            if (w) {
                ...
                if (a && !_ && !i && !r) {
                    ...
                    s = t396_elem__getHeight(e, s), s = t396_elem__convertPosition__Local__toAbsolute(e, "height", s);
                    var n = t396_elem__getFieldValue(e, "width");
                    n = t396_elem__getWidth(e, n), n = t396_elem__convertPosition__Local__toAbsolute(e, "width", n);
                    var c = parseFloat(t396_elem__getFieldValue(e, "top"));
                    c = t396_elem__convertPosition__Local__toAbsolute(e, "top", c), c *= window.tn_scale_factor, c += (s * window.tn_scale_factor - s) / 2;
                    var d, m, p = parseFloat(t396_elem__getFieldValue(e, "left"));
                    for (p = t396_elem__convertPosition__Local__toAbsolute(e, "left", p), p *= window.tn_scale_factor, p += (n * window.tn_scale_factor - n) / 2, e.style.top = c + "px", e.style.left = p + "px", (d = t.parentNode) && d.classList.contains("tn-atom__scale-wrapper") && (d = d.parentNode), (m = document.createElement("div")).classList.add("tn-atom__scale-wrapper"), m.style.transform = "scale(" + window.tn_scale_factor + ")"; d.firstChild;) d.removeChild(d.firstChild);
                    m.appendChild(t), d && d.appendChild(m), e.setAttribute("data-scale-off", "yes")
                }
                "shape" === l && (s = t396_elem__getFieldValue(e, "height"), s = t396_elem__getHeight(e, s), s = t396_elem__convertPosition__Local__toAbsolute(e, "height", s), n = t396_elem__getFieldValue(e, "width"), n = t396_elem__getWidth(e, n), n = t396_elem__convertPosition__Local__toAbsolute(e, "width", n), c = parseFloat(t396_elem__getFieldValue(e, "top")), c = t396_elem__convertPosition__Local__toAbsolute(e, "top", c), p = parseFloat(t396_elem__getFieldValue(e, "left")), p = t396_elem__convertPosition__Local__toAbsolute(e, "left", p), l = (m = window.getComputedStyle(t)).borderWidth, m = "none" !== m.backgroundImage, _ = e.getAttribute("data-animate-sbs-event"), !(s <= 2 || n <= 2) || "0px" !== l || m || _ || (e.style.removeProperty("zoom"), n = n * window.tn_scale_factor, s = s * window.tn_scale_factor, c = c * window.tn_scale_factor, p = p * window.tn_scale_factor, e.style.width = parseFloat(n) + "px", e.style.height = parseFloat(s) + "px", e.style.top = Math.round(c) + "px", e.style.left = Math.round(p) + "px", e.setAttribute("data-scale-off", "yes"))), "text" === e.getAttribute("data-elem-type") && u < 1200 && t && (t.style.webkitTextSizeAdjust = "auto"), t && (t.style.transformOrigin = "center")
            }
    })
}
